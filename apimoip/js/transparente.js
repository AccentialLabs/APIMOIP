...
sendToDebit = function() {
  ...
  $("#link-debito").append("<a href='https://desenvolvedor.moip.com.br/sandbox/Instrucao.do?token=" + $("#MoipWidget").attr("data-token") + "' target='_blank'>Abrir</a>");
}
...
sendToBoleto = function() {
  ...
  $("#link-boleto").append("<a href='https://desenvolvedor.moip.com.br/sandbox/Instrucao.do?token=" + $("#MoipWidget").attr("data-token") + "' target='_blank'>Abrir</a>");
}
